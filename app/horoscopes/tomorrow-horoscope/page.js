...
export async function generateMetadata() {
  ...
  try {
    const response = await fetch(process.env.NEXT_PUBLIC_TOMORROW_HOROSCOPE, {
      cache: "no-store",
    });
...
const HoroscopeTomorrowStaticPage = async () => {
  let data = null;
  let error = null;
...
export default HoroscopeTomorrowStaticPage;
